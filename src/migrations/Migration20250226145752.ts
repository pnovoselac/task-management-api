...
export class Migration20250226145752 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table "task" alter column "priority" type varchar(255) using ("priority"::varchar(255));`);
    this.addSql(`alter table "task" alter column "priority" set default 'Low';`);
  ...
  override async down(): Promise<void> {
    this.addSql(`alter table "task" alter column "priority" drop default;`);
    this.addSql(`alter table "task" alter column "priority" type varchar(255) using ("priority"::varchar(255));`);
